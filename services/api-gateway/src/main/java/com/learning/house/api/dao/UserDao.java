package com.learning.house.api.dao;

import com.learning.house.api.common.RestResponse;
import com.learning.house.api.config.GenericRest;
...
import com.learning.house.api.utils.Rests;
...
public class UserDao {
   ...
   * @return
   */
  @HystrixCommand(fallbackMethod="getUserByTokenFb")//ignoreException=RuntimeExceptions.class
